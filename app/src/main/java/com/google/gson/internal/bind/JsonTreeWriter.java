...
public final class JsonTreeWriter extends JsonWriter {
    ...
    public JsonElement get() {
        ...
        StringBuilder r1 = outline.m2549("Expected one JSON element but was ");
        r1.append(this.stack);
    ...
    public JsonWriter value(Number number) {
        ...
        if (!isLenient()) {
            ...
            if (Double.isNaN(doubleValue) || Double.isInfinite(doubleValue)) {
                throw new IllegalArgumentException(outline.m2554("JSON forbids NaN and infinities: ", (Object) number));
            }
        }
