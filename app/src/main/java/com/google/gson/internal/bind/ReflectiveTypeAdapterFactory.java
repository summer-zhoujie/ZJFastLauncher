...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory {
    ...
    private Map<String, BoundField> getBoundFields(Gson gson, TypeToken<?> typeToken, Class<?> cls) {
        ...
        while (cls2 != Object.class) {
            ...
            while (i < length) {
                ...
                if (excludeField || excludeField2) {
                    ...
                    while (i2 < size) {
                        ...
                        Type type2 = resolve;
                        Field field2 = field;
                        boundField = boundField2 == null ? (BoundField) linkedHashMap.put(str, createBoundField(gson, field, str, new TypeToken(resolve), z4, excludeField2)) : boundField2;
                        i2 = i3 + 1;
                        z3 = z4;
                        resolve = type2;
                        size = i4;
            ...
            typeToken2 = new TypeToken<>(C$Gson$Types.resolve(typeToken2.getType(), cls2, cls2.getGenericSuperclass()));
