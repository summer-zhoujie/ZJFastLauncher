...
public final class C$Gson$Types {
    ...
    private static final class WildcardTypeImpl implements WildcardType, Serializable {
        ...
        public String toString() {
            if (this.lowerBound != null) {
                StringBuilder r0 = outline.m2549("? super ");
                r0.append(C$Gson$Types.typeToString(this.lowerBound));
                return r0.toString();
            } else if (this.upperBound == Object.class) {
                return "?";
            } else {
                StringBuilder r02 = outline.m2549("? extends ");
                r02.append(C$Gson$Types.typeToString(this.upperBound));
                return r02.toString();
            }
        }
    }
    ...
    public static Type resolve(Type r8, Class<?> r9, Type r10, Collection<TypeVariable> r11) {
        /*
        L_0x0000:
        ...
        L_0x00ae:
            ...
            r0 = r3[r2]
            java.lang.reflect.Type r8 = resolve(r8, r9, r0, r11)     // Catch:{ Throwable -> 0x00c1 }
            r9 = r3[r2]
            if (r8 == r9) goto L_0x00c0
