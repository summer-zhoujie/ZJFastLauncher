...
public final class MapTypeAdapterFactory implements TypeAdapterFactory {
            ...
            if (peek == JsonToken.BEGIN_ARRAY) {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (map.put(read, this.valueTypeAdapter.read(jsonReader)) == null) {
                        ...
                        throw new JsonSyntaxException(outline.m2554("duplicate key: ", (Object) read));
                    }
                }
                jsonReader.endArray();
            } else {
                ...
                while (jsonReader.hasNext()) {
                    ...
                    if (map.put(read2, this.valueTypeAdapter.read(jsonReader)) != null) {
                        throw new JsonSyntaxException(outline.m2554("duplicate key: ", (Object) read2));
                    }
                }
    ...
    private TypeAdapter<?> getKeyAdapter(Gson gson, Type type) {
        ...
        return gson.getAdapter(new TypeToken(type));
    }
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> typeToken) {
        ...
        return new Adapter(gson, mapKeyAndValueTypes[0], getKeyAdapter(gson, mapKeyAndValueTypes[0]), mapKeyAndValueTypes[1], gson.getAdapter(new TypeToken(mapKeyAndValueTypes[1])), this.constructorConstructor.get(typeToken));
    }
}
