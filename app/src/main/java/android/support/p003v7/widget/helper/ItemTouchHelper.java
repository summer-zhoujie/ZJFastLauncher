...
public class ItemTouchHelper extends RecyclerView.ItemDecoration implements RecyclerView.OnChildAttachStateChangeListener {
    ...
    /* renamed from: UP */
    public static final int f44UP = 1;
    ...
    public final Runnable mScrollRunnable = new Runnable() {
        public void run() {
            ...
            if (itemTouchHelper.mSelected != null && itemTouchHelper.scrollIfNecessary()) {
                ...
                ItemTouchHelper itemTouchHelper3 = ItemTouchHelper.this;
                itemTouchHelper3.mRecyclerView.removeCallbacks(itemTouchHelper3.mScrollRunnable);
                ViewCompat.IMPL.postOnAnimation(ItemTouchHelper.this.mRecyclerView, this);
            }
        }
    };
    ...
    public static abstract class Callback {
        ...
        public static final ItemTouchUIUtil sUICallback = new ItemTouchUIUtilImpl.Api21Impl();
        ...
        private int getMaxDragScroll(RecyclerView recyclerView) {
            if (this.mCachedMaxScrollSpeed == -1) {
                this.mCachedMaxScrollSpeed = recyclerView.getResources().getDimensionPixelSize(C0179R.dimen.item_touch_helper_max_drag_scroll_per_frame);
            }
    ...
    private static class RecoverAnimation implements Animator.AnimatorListener {
        ...
        public void update() {
            ...
            if (f == f2) {
                ...
                this.f45mX = ((f2 - f) * this.mFraction) + f;
            }
            ...
            this.f46mY = ((f4 - f3) * this.mFraction) + f3;
        }
    }
    ...
    public void attachToRecyclerView(@Nullable RecyclerView recyclerView) {
        ...
        if (recyclerView2 != recyclerView) {
            ...
            if (recyclerView != null) {
                ...
                this.mSwipeEscapeVelocity = resources.getDimension(C0179R.dimen.item_touch_helper_swipe_escape_velocity);
                this.mMaxSwipeVelocity = resources.getDimension(C0179R.dimen.item_touch_helper_swipe_escape_max_velocity);
                setupCallbacks();
            }
        }
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void select(android.support.p003v7.widget.RecyclerView.ViewHolder r24, int r25) {
        /*
            r23 = this;
            r11 = r23
            r12 = r24
