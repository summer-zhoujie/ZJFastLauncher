...
public class AdapterHelper implements OpReorderer.Callback {
    ...
    static class UpdateOp {
        ...
        public String toString() {
            ...
            sb.append(",p:");
            return outline.m2546(sb, this.payload, "]");
        }
    }
    ...
    private void dispatchAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        if (i4 == 2) {
            ...
            throw new IllegalArgumentException(outline.m2554("op should be remove or update.", (Object) updateOp));
        }
        int i5 = 1;
    ...
    private void postponeAndUpdateViewHolders(UpdateOp updateOp) {
        ...
        if (i == 1) {
            ...
            throw new IllegalArgumentException(outline.m2554("Unknown update op type for ", (Object) updateOp));
        }
    }
