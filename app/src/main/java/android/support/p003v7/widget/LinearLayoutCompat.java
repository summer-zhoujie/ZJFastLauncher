...
public class LinearLayoutCompat extends ViewGroup {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:184:0x044f  */
    /* JADX WARNING: Removed duplicated region for block: B:188:0x0471  */
    ...
    public void measureHorizontal(int r39, int r40) {
        ...
        L_0x041a:
            r2 = 1073741824(0x40000000, float:2.0)
            if (r13 == r2) goto L_0x0425
            int r2 = r5.height
            r8 = -1
            if (r2 != r8) goto L_0x0425
            r2 = 1
            goto L_0x0426
        L_0x0425:
            r2 = 0
    ...
    /* JADX WARNING: Removed duplicated region for block: B:147:0x033f  */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public void measureVertical(int r34, int r35) {
        ...
        L_0x0310:
            ...
            if (r12 == r15) goto L_0x032b
            int r15 = r14.width
            r23 = r1
            r1 = -1
            if (r15 != r1) goto L_0x032e
            r15 = 1
            goto L_0x032f
        L_0x032b:
            r23 = r1
        ...
        L_0x0333:
            ...
            if (r19 == 0) goto L_0x033f
            int r9 = r14.width
            if (r9 != r1) goto L_0x033f
            r9 = 1
            goto L_0x0340
        L_0x033f:
            r9 = 0
    ...
    public void setBaselineAlignedChildIndex(int i) {
        if (i < 0 || i >= getChildCount()) {
            StringBuilder r0 = outline.m2549("base aligned child index out of range (0, ");
    ...
    public LinearLayoutCompat(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.LinearLayoutCompat, i, 0);
        int i2 = obtainStyledAttributes.getInt(C0176R.styleable.LinearLayoutCompat_android_orientation, -1);
        if (i2 >= 0) {
            setOrientation(i2);
        }
        int i3 = obtainStyledAttributes.getInt(C0176R.styleable.LinearLayoutCompat_android_gravity, -1);
        if (i3 >= 0) {
            setGravity(i3);
        }
        boolean z = obtainStyledAttributes.getBoolean(C0176R.styleable.LinearLayoutCompat_android_baselineAligned, true);
        if (!z) {
            setBaselineAligned(z);
        }
        this.mWeightSum = obtainStyledAttributes.getFloat(C0176R.styleable.LinearLayoutCompat_android_weightSum, -1.0f);
        this.mBaselineAlignedChildIndex = obtainStyledAttributes.getInt(C0176R.styleable.LinearLayoutCompat_android_baselineAlignedChildIndex, -1);
        this.mUseLargestChild = obtainStyledAttributes.getBoolean(C0176R.styleable.LinearLayoutCompat_measureWithLargestChild, false);
        setDividerDrawable(obtainStyledAttributes.getDrawable(C0176R.styleable.LinearLayoutCompat_divider));
        this.mShowDividers = obtainStyledAttributes.getInt(C0176R.styleable.LinearLayoutCompat_showDividers, 0);
        this.mDividerPadding = obtainStyledAttributes.getDimensionPixelSize(C0176R.styleable.LinearLayoutCompat_dividerPadding, 0);
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            this.gravity = -1;
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0176R.styleable.LinearLayoutCompat_Layout);
            this.weight = obtainStyledAttributes.getFloat(C0176R.styleable.LinearLayoutCompat_Layout_android_layout_weight, 0.0f);
            this.gravity = obtainStyledAttributes.getInt(C0176R.styleable.LinearLayoutCompat_Layout_android_layout_gravity, -1);
            obtainStyledAttributes.recycle();
        }
