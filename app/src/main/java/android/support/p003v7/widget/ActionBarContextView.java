...
public class ActionBarContextView extends AbsActionBarView {
    ...
    public ActionBarContextView(Context context) {
        this(context, (AttributeSet) null, C0176R.attr.actionModeStyle);
    }
    ...
    private void initTitle() {
        if (this.mTitleLayout == null) {
            ...
            this.mTitleView = (TextView) this.mTitleLayout.findViewById(C0176R.C0178id.action_bar_title);
            this.mSubtitleView = (TextView) this.mTitleLayout.findViewById(C0176R.C0178id.action_bar_subtitle);
    ...
    public void initForMode(final ActionMode actionMode) {
        ...
        this.mClose.findViewById(C0176R.C0178id.action_mode_close_button).setOnClickListener(new OnClickListener() {
        ...
        ViewCompat.IMPL.setBackground(this.mMenuView, (Drawable) null);
    ...
    public ActionBarContextView(Context context, AttributeSet attributeSet, int i) {
        ...
        TintTypedArray obtainStyledAttributes = TintTypedArray.obtainStyledAttributes(context, attributeSet, C0176R.styleable.ActionMode, i, 0);
        ViewCompat.IMPL.setBackground(this, obtainStyledAttributes.getDrawable(C0176R.styleable.ActionMode_background));
        this.mTitleStyleRes = obtainStyledAttributes.getResourceId(C0176R.styleable.ActionMode_titleTextStyle, 0);
        this.mSubtitleStyleRes = obtainStyledAttributes.getResourceId(C0176R.styleable.ActionMode_subtitleTextStyle, 0);
        this.mContentHeight = obtainStyledAttributes.getLayoutDimension(C0176R.styleable.ActionMode_height, 0);
        this.mCloseItemLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.ActionMode_closeItemLayout, C0176R.layout.abc_action_mode_close_item_material);
