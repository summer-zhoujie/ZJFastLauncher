...
public class StaggeredGridLayoutManager extends RecyclerView.LayoutManager implements RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void updateLayoutState(int r5, RecyclerView.State r6) {
        /*
            r4 = this;
    ...
    public int[] findFirstCompletelyVisibleItemPositions(int[] iArr) {
        if (iArr == null) {
            ...
            StringBuilder r1 = outline.m2549("Provided int[]'s size must be more than or equal to span count. Expected:");
            r1.append(this.mSpanCount);
            r1.append(", array size:");
            r1.append(iArr.length);
     ...
     */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private void onLayoutChildren(RecyclerView.Recycler r9, RecyclerView.State r10, boolean r11) {
        /*
            r8 = this;
        ...
        L_0x0073:
            ...
            android.support.v7.widget.StaggeredGridLayoutManager$Span[] r6 = r8.mSpans
            r6 = r6[r1]
            r6.setLine(r5)
        L_0x008b:
            int r1 = r1 + 1
    ...
    static class LazySpanLookup {
        ...
        static class FullSpanItem implements Parcelable {
            ...
            public String toString() {
                StringBuilder r0 = outline.m2549("FullSpanItem{mPosition=");
                r0.append(this.mPosition);
                r0.append(", mGapDir=");
                r0.append(this.mGapDir);
                r0.append(", mHasUnwantedGapAfter=");
                r0.append(this.mHasUnwantedGapAfter);
                r0.append(", mGapPerSpan=");
                r0.append(Arrays.toString(this.mGapPerSpan));
                r0.append('}');
                return r0.toString();
            }
