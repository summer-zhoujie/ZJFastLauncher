...
public final class LocaleListHelper {
    ...
    public LocaleListHelper(@NonNull Locale... localeArr) {
        if (localeArr.length == 0) {
            ...
            this.mStringRepresentation = BidiFormatter.EMPTY_STRING;
            return;
        }
    ...
    public static String getLikelyScript(Locale locale) {
        ...
        return !script.isEmpty() ? script : BidiFormatter.EMPTY_STRING;
    }
    ...
    @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
    public static void setDefault(@Size(min = 1) @NonNull LocaleListHelper localeListHelper, int i) {
