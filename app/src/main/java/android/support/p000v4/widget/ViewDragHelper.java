...
public class ViewDragHelper {
    ...
    private void dragTo(int i, int i2, int i3, int i4) {
        ...
        if (i3 != 0) {
            ...
            ViewCompat.IMPL.offsetLeftAndRight(this.mCapturedView, i - left);
        }
        int i5 = i;
        if (i4 != 0) {
            i2 = this.mCallback.clampViewPositionVertical(this.mCapturedView, i2, i4);
            ViewCompat.IMPL.offsetTopAndBottom(this.mCapturedView, i2 - top);
        }
        int i6 = i2;
        if (i3 != 0 || i4 != 0) {
    ...
    public void captureChildView(@NonNull View view, int i) {
        ...
        throw new IllegalArgumentException(outline.m2546(outline.m2549("captureChildView: parameter must be a descendant of the ViewDragHelper's tracked parent view ("), (Object) this.mParentView, ")"));
    }
    ...
    public boolean continueSettling(boolean z) {
        if (this.mDragState == 2) {
            ...
            if (left != 0) {
                ViewCompat.IMPL.offsetLeftAndRight(this.mCapturedView, left);
            }
            if (top != 0) {
                ViewCompat.IMPL.offsetTopAndBottom(this.mCapturedView, top);
            }
            if (!(left == 0 && top == 0)) {
    ...
    public boolean shouldInterceptTouchEvent(@android.support.annotation.NonNull MotionEvent r17) {
        /*
            r16 = this;
            r0 = r16
            r1 = r17
