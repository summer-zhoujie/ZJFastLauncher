...
public class Preconditions {
    ...
    public static float checkArgumentFinite(float f, String str) {
        if (Float.isNaN(f)) {
            throw new IllegalArgumentException(outline.m2556(str, " must not be NaN"));
        } else if (!Float.isInfinite(f)) {
            return f;
        } else {
            throw new IllegalArgumentException(outline.m2556(str, " must not be infinite"));
        }
    }
    ...
    public static <T> T[] checkArrayElementsNotNull(T[] tArr, String str) {
        ...
        throw new NullPointerException(outline.m2556(str, " must not be null"));
    }
    ...
    public static <T> Collection<T> checkCollectionNotEmpty(Collection<T> collection, String str) {
        if (collection == null) {
            ...
            throw new IllegalArgumentException(outline.m2556(str, " is empty"));
        }
    }
    ...
    public static int checkFlagsArgument(int i, int i2) {
        ...
        StringBuilder r1 = outline.m2549("Requested flags 0x");
        r1.append(Integer.toHexString(i));
        r1.append(", but only 0x");
        r1.append(Integer.toHexString(i2));
        r1.append(" are allowed");
