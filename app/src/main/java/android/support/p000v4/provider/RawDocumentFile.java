...
public class RawDocumentFile extends DocumentFile {
    ...
    public static boolean deleteContents(File file) {
        ...
        for (File file2 : listFiles) {
            ...
            if (!file2.delete()) {
                outline.m2552("Failed to delete ", (Object) file2);
                z = false;
            }
        }
        return z;
    ...
    public static String getTypeForName(String r1) {
        /*
            r0 = 46
    ...
    public DocumentFile createFile(String str, String str2) {
        ...
        if (extensionFromMimeType != null) {
            str2 = outline.m2545(str2, ".", extensionFromMimeType);
        }
        ...
        try {
            ...
            outline.m2552("Failed to createFile: ", (Object) e);
            return null;
        }
    }
