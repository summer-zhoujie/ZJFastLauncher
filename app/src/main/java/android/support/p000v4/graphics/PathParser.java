...
public class PathParser {
    ...
    public static Path createPathFromPathData(String str) {
        ...
        try {
            ...
            throw new RuntimeException(outline.m2556("Error in parsing ", str), e);
        }
    }
    ...
    public static void extract(String r8, int r9, ExtractFloatResult r10) {
        /*
            r0 = 0
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:22:0x004a, code lost:
        r8 = true;
     */
    /* JADX WARNING: Removed duplicated region for block: B:28:0x0055 A[Catch:{ NumberFormatException -> 0x0073 }, LOOP:1: B:8:0x0028->B:28:0x0055, LOOP_END] */
    /* JADX WARNING: Removed duplicated region for block: B:46:0x0054 A[SYNTHETIC] */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static float[] getFloats(String r12) {
        /*
            r0 = 0
            ...
            goto L_0x0082
        L_0x0013:
            int r1 = r12.length()     // Catch:{ NumberFormatException -> 0x0073 }
            float[] r1 = new float[r1]     // Catch:{ NumberFormatException -> 0x0073 }
            int r2 = r12.length()     // Catch:{ NumberFormatException -> 0x0073 }
            r3 = 1
            r4 = 0
        L_0x001f:
            ...
            r9 = 0
        L_0x0028:
            int r10 = r12.length()     // Catch:{ NumberFormatException -> 0x0073 }
            if (r5 >= r10) goto L_0x0058
            char r10 = r12.charAt(r5)     // Catch:{ NumberFormatException -> 0x0073 }
            r11 = 32
        ...
        L_0x0058:
            ...
            int r6 = r4 + 1
            java.lang.String r3 = r12.substring(r3, r5)     // Catch:{ NumberFormatException -> 0x0073 }
            float r3 = java.lang.Float.parseFloat(r3)     // Catch:{ NumberFormatException -> 0x0073 }
            r1[r4] = r3     // Catch:{ NumberFormatException -> 0x0073 }
            r4 = r6
        L_0x0067:
        ...
        L_0x006b:
            ...
            goto L_0x001f
        L_0x006e:
            float[] r12 = copyOfRange(r1, r0, r4)     // Catch:{ NumberFormatException -> 0x0073 }
            return r12
        L_0x0073:
            r0 = move-exception
            ...
            java.lang.String r3 = "\""
            java.lang.String r12 = com.wpengapp.support.outline.m2545((java.lang.String) r2, (java.lang.String) r12, (java.lang.String) r3)
            r1.<init>(r12, r0)
            throw r1
        L_0x0082:
            ...
            return r12
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.graphics.PathParser.getFloats(java.lang.String):float[]");
    }
    ...
    public static class PathDataNode {
        ...
        public static void arcToBezier(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
            ...
            while (i < ceil) {
                ...
                float f = (float) ((d21 * sqrt) + d20);
                float f2 = (float) (d25 - (sqrt * d27));
                path.cubicTo((float) ((d22 * sqrt) + d19), f, f2, (float) (d26 - (sqrt * d28)), (float) d25, (float) d26);
                i++;
                d18 = d18;
                ceil = i3;
                sin = sin;
