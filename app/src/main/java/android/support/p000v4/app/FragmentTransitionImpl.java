...
public abstract class FragmentTransitionImpl {
    ...
    public ArrayList<String> prepareSetNameOverridesReordered(ArrayList<View> arrayList) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            ViewCompat.IMPL.setTransitionName(view, (String) null);
        }
        return arrayList2;
    }
        ...
        OneShotPreDrawListener.add(viewGroup, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    String transitionName = ViewCompat.getTransitionName(view);
                    ViewCompat.IMPL.setTransitionName(view, (String) map.get(transitionName));
                }
            }
        });
    }
        ...
        OneShotPreDrawListener.add(view, new Runnable() {
            public void run() {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    String transitionName = ViewCompat.getTransitionName(view);
                    if (transitionName != null) {
                        ViewCompat.IMPL.setTransitionName(view, FragmentTransitionImpl.findKeyForValue(map, transitionName));
                    }
                }
            }
        });
    ...
    public void setNameOverridesReordered(View view, ArrayList<View> arrayList, ArrayList<View> arrayList2, ArrayList<String> arrayList3, Map<String, String> map) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (transitionName != null) {
                ViewCompat.IMPL.setTransitionName(view2, (String) null);
                ...
                while (true) {
                    if (i2 >= size) {
                        ...
                        ViewCompat.IMPL.setTransitionName(arrayList2.get(i2), transitionName);
                        break;
                    } else {
                        i2++;
                    }
        ...
        OneShotPreDrawListener.add(view, new Runnable() {
            public void run() {
                for (int i = 0; i < size; i++) {
                    ViewCompat.IMPL.setTransitionName((View) arrayList5.get(i), (String) arrayList6.get(i));
                    ViewCompat.IMPL.setTransitionName((View) arrayList7.get(i), (String) arrayList4.get(i));
                }
            }
        });
    }
