...
public class ShortcutManagerCompat {
    ...
    public static boolean isRequestPinShortcutSupported(@android.support.annotation.NonNull Context r4) {
        /*
        ...
        L_0x0013:
            ...
            int r1 = android.support.p000v4.content.ContextCompat.checkSelfPermission(r4, r0)
            r2 = 0
