...
public abstract class ActionProvider {
    ...
    public void setVisibilityListener(VisibilityListener visibilityListener) {
        if (!(this.mVisibilityListener == null || visibilityListener == null)) {
            StringBuilder r0 = outline.m2549("setVisibilityListener: Setting a new ActionProvider.VisibilityListener when one is already set. Are you reusing this ");
            r0.append(getClass().getSimpleName());
            r0.append(" instance while it is still in use somewhere else?");
            r0.toString();
        }
