...
public class PagerTitleStrip extends ViewGroup {
    ...
    public void setNonPrimaryAlpha(@FloatRange(from = 0.0d, mo35to = 1.0d) float f) {
    ...
    public PagerTitleStrip(@NonNull Context context, @Nullable AttributeSet attributeSet) {
        ...
        if (resourceId != 0) {
            TextViewCompat.IMPL.setTextAppearance(this.mPrevText, resourceId);
            TextViewCompat.IMPL.setTextAppearance(this.mCurrText, resourceId);
            TextViewCompat.IMPL.setTextAppearance(this.mNextText, resourceId);
        }
