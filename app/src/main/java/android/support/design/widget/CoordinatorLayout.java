...
import android.support.coreui.C0013R;
...
public class CoordinatorLayout extends ViewGroup implements NestedScrollingParent2 {
    ...
    public CoordinatorLayout(Context context) {
        this(context, (AttributeSet) null, C0013R.attr.coordinatorLayoutStyle);
    }
    ...
    private void getDesiredAnchoredChildRectWithoutConstraints(View view, int i, Rect rect, Rect rect2, LayoutParams layoutParams, int i2, int i3) {
        ...
        int absoluteGravity = GravityCompat.getAbsoluteGravity(i6, i);
    ...
    private void offsetChildByInset(View view, Rect rect, int i) {
        ...
        if (ViewCompat.isLaidOut(view) && view.getWidth() > 0 && view.getHeight() > 0) {
            ...
            if (behavior == null || !behavior.getInsetDodgeRect(this, view, acquireTempRect)) {
                ...
                StringBuilder r10 = outline.m2549("Rect should be within the child's bounds. Rect:");
    ...
    public static Behavior parseBehavior(Context context, AttributeSet attributeSet, String str) {
        ...
        try {
            ...
            throw new RuntimeException(outline.m2556("Could not inflate Behavior subclass ", str), e);
        }
    }
    ...
    private void setInsetOffsetX(View view, int i) {
        ...
        if (i2 != i) {
            ViewCompat.IMPL.offsetLeftAndRight(view, i - i2);
    ...
    private void setInsetOffsetY(View view, int i) {
        ...
        if (i2 != i) {
            ViewCompat.IMPL.offsetTopAndBottom(view, i - i2);
    ...
    private void setupForInsets() {
        ...
        if (ViewCompat.getFitsSystemWindows(this)) {
            ...
            ViewCompat.IMPL.setOnApplyWindowInsetsListener(this, this.mApplyWindowInsetsListener);
            setSystemUiVisibility(1280);
            return;
        }
        ViewCompat.IMPL.setOnApplyWindowInsetsListener(this, (OnApplyWindowInsetsListener) null);
    }
            ...
            if (view instanceof AttachedBehavior) {
                ...
                if (defaultBehavior != null) {
                    try {
                        ...
                        StringBuilder r6 = outline.m2549("Default behavior class ");
                        r6.append(defaultBehavior.value().getName());
                        r6.append(" could not be instantiated. Did you forget");
                        r6.append(" a default constructor?");
                        r6.toString();
                    }
                }
                layoutParams.mBehaviorResolved = true;
    ...
    public void offsetChildToAnchor(View view, int i) {
        ...
        if (layoutParams.mAnchorView != null) {
            ...
            if (i3 != 0) {
                ViewCompat.IMPL.offsetLeftAndRight(view2, i3);
            }
            if (i4 != 0) {
                ViewCompat.IMPL.offsetTopAndBottom(view2, i4);
            }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, C0013R.attr.coordinatorLayoutStyle);
    }
    ...
    public CoordinatorLayout(Context context, AttributeSet attributeSet, int i) {
        ...
        if (i == 0) {
            typedArray = context.obtainStyledAttributes(attributeSet, C0013R.styleable.CoordinatorLayout, 0, C0013R.style.Widget_Support_CoordinatorLayout);
        } else {
            typedArray = context.obtainStyledAttributes(attributeSet, C0013R.styleable.CoordinatorLayout, i, 0);
        }
        int resourceId = typedArray.getResourceId(C0013R.styleable.CoordinatorLayout_keylines, 0);
        if (resourceId != 0) {
        ...
        this.mStatusBarBackground = typedArray.getDrawable(C0013R.styleable.CoordinatorLayout_statusBarBackground);
        typedArray.recycle();
        setupForInsets();
    ...
    public static class LayoutParams extends MarginLayoutParams {
        ...
        private void resolveAnchorView(View view, CoordinatorLayout coordinatorLayout) {
            ...
            if (view2 != null) {
                ...
                StringBuilder r1 = outline.m2549("Could not find CoordinatorLayout descendant view with id ");
                r1.append(coordinatorLayout.getResources().getResourceName(this.mAnchorId));
         ...
         */
        /* Code decompiled incorrectly, please refer to instructions dump. */
        public boolean dependsOn(CoordinatorLayout r2, View r3, View r4) {
            /*
                r1 = this;
        ...
        public LayoutParams(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0013R.styleable.CoordinatorLayout_Layout);
            this.gravity = obtainStyledAttributes.getInteger(C0013R.styleable.CoordinatorLayout_Layout_android_layout_gravity, 0);
            this.mAnchorId = obtainStyledAttributes.getResourceId(C0013R.styleable.CoordinatorLayout_Layout_layout_anchor, -1);
            this.anchorGravity = obtainStyledAttributes.getInteger(C0013R.styleable.CoordinatorLayout_Layout_layout_anchorGravity, 0);
            this.keyline = obtainStyledAttributes.getInteger(C0013R.styleable.CoordinatorLayout_Layout_layout_keyline, -1);
            this.insetEdge = obtainStyledAttributes.getInt(C0013R.styleable.CoordinatorLayout_Layout_layout_insetEdge, 0);
            this.dodgeInsetEdges = obtainStyledAttributes.getInt(C0013R.styleable.CoordinatorLayout_Layout_layout_dodgeInsetEdges, 0);
            this.mBehaviorResolved = obtainStyledAttributes.hasValue(C0013R.styleable.CoordinatorLayout_Layout_layout_behavior);
            if (this.mBehaviorResolved) {
                this.mBehavior = CoordinatorLayout.parseBehavior(context, attributeSet, obtainStyledAttributes.getString(C0013R.styleable.CoordinatorLayout_Layout_layout_behavior));
            }
