...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintLeft_creator, 75);
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintTop_creator, 75);
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintRight_creator, 75);
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintBottom_creator, 75);
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintBaseline_creator, 75);
        ...
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintWidth_percent, 69);
        mapToConstant.append(C0007R.styleable.ConstraintSet_layout_constraintHeight_percent, 70);
        mapToConstant.append(C0007R.styleable.ConstraintSet_chainUseRtl, 71);
        mapToConstant.append(C0007R.styleable.ConstraintSet_barrierDirection, 72);
        mapToConstant.append(C0007R.styleable.ConstraintSet_constraint_referenced_ids, 73);
        mapToConstant.append(C0007R.styleable.ConstraintSet_barrierAllowsGoneWidgets, 74);
    }
    ...
    private Constraint fillFromAttributeList(Context context, AttributeSet attributeSet) {
        Constraint constraint = new Constraint();
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0007R.styleable.ConstraintSet);
    ...
    private void populateConstraint(Constraint constraint, TypedArray typedArray) {
        ...
        for (int i = 0; i < indexCount; i++) {
            ...
            switch (i2) {
                case 1:
                    int resourceId = typedArray.getResourceId(index, constraint.baselineToBaseline);
                    if (resourceId == -1) {
                        resourceId = typedArray.getInt(index, -1);
                    }
                    constraint.baselineToBaseline = resourceId;
                    break;
                case 2:
                    constraint.bottomMargin = typedArray.getDimensionPixelSize(index, constraint.bottomMargin);
                    break;
                case 3:
                    int resourceId2 = typedArray.getResourceId(index, constraint.bottomToBottom);
                    if (resourceId2 == -1) {
                        resourceId2 = typedArray.getInt(index, -1);
                    }
                    constraint.bottomToBottom = resourceId2;
                    break;
                case 4:
                    int resourceId3 = typedArray.getResourceId(index, constraint.bottomToTop);
                    if (resourceId3 == -1) {
                        resourceId3 = typedArray.getInt(index, -1);
                    }
                    constraint.bottomToTop = resourceId3;
                    break;
                case 5:
                ...
                case 8:
                    ...
                    break;
                case 9:
                    int resourceId4 = typedArray.getResourceId(index, constraint.endToEnd);
                    if (resourceId4 == -1) {
                        resourceId4 = typedArray.getInt(index, -1);
                    }
                    constraint.endToEnd = resourceId4;
                    break;
                case 10:
                    int resourceId5 = typedArray.getResourceId(index, constraint.endToStart);
                    if (resourceId5 == -1) {
                        resourceId5 = typedArray.getInt(index, -1);
                    }
                    constraint.endToStart = resourceId5;
                    break;
                case 11:
                ...
                case 24:
                    ...
                    break;
                case 25:
                    int resourceId6 = typedArray.getResourceId(index, constraint.leftToLeft);
                    if (resourceId6 == -1) {
                        resourceId6 = typedArray.getInt(index, -1);
                    }
                    constraint.leftToLeft = resourceId6;
                    break;
                case 26:
                    int resourceId7 = typedArray.getResourceId(index, constraint.leftToRight);
                    if (resourceId7 == -1) {
                        resourceId7 = typedArray.getInt(index, -1);
                    }
                    constraint.leftToRight = resourceId7;
                    break;
                case 27:
                ...
                case 28:
                    ...
                    break;
                case 29:
                    int resourceId8 = typedArray.getResourceId(index, constraint.rightToLeft);
                    if (resourceId8 == -1) {
                        resourceId8 = typedArray.getInt(index, -1);
                    }
                    constraint.rightToLeft = resourceId8;
                    break;
                case 30:
                    int resourceId9 = typedArray.getResourceId(index, constraint.rightToRight);
                    if (resourceId9 == -1) {
                        resourceId9 = typedArray.getInt(index, -1);
                    }
                    constraint.rightToRight = resourceId9;
                    break;
                case 31:
                    constraint.startMargin = typedArray.getDimensionPixelSize(index, constraint.startMargin);
                    break;
                case 32:
                    int resourceId10 = typedArray.getResourceId(index, constraint.startToEnd);
                    if (resourceId10 == -1) {
                        resourceId10 = typedArray.getInt(index, -1);
                    }
                    constraint.startToEnd = resourceId10;
                    break;
                case 33:
                    int resourceId11 = typedArray.getResourceId(index, constraint.startToStart);
                    if (resourceId11 == -1) {
                        resourceId11 = typedArray.getInt(index, -1);
                    }
                    constraint.startToStart = resourceId11;
                    break;
                case 34:
                    constraint.topMargin = typedArray.getDimensionPixelSize(index, constraint.topMargin);
                    break;
                case 35:
                    int resourceId12 = typedArray.getResourceId(index, constraint.topToBottom);
                    if (resourceId12 == -1) {
                        resourceId12 = typedArray.getInt(index, -1);
                    }
                    constraint.topToBottom = resourceId12;
                    break;
                case 36:
                    int resourceId13 = typedArray.getResourceId(index, constraint.topToTop);
                    if (resourceId13 == -1) {
                        resourceId13 = typedArray.getInt(index, -1);
                    }
                    constraint.topToTop = resourceId13;
                    break;
                case 37:
                ...
                default:
                    switch (i2) {
                        case 60:
                            ...
                            break;
                        case 61:
                            int resourceId14 = typedArray.getResourceId(index, constraint.circleConstraint);
                            if (resourceId14 == -1) {
                                resourceId14 = typedArray.getInt(index, -1);
                            }
                            constraint.circleConstraint = resourceId14;
                            break;
                        case 62:
                        ...
                        default:
                            switch (i2) {
                                ...
                                case 74:
                                    ...
                                    break;
                                case 75:
                                    StringBuilder r3 = outline.m2549("unused attribute 0x");
                                    r3.append(Integer.toHexString(index));
                                    r3.append("   ");
                                    r3.append(mapToConstant.get(index));
                                    r3.toString();
                                    break;
                                default:
                                    StringBuilder r32 = outline.m2549("Unknown attribute 0x");
                                    r32.append(Integer.toHexString(index));
                                    r32.append("   ");
                                    r32.append(mapToConstant.get(index));
                                    r32.toString();
                                    break;
                            }
                    }
        ...
        switch (i2) {
            case 1:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(outline.m2548(outline.m2549("Left to "), sideToString(i4), " undefined"));
                }
            ...
            case 2:
                if (i4 == 1) {
                    ...
                    throw new IllegalArgumentException(outline.m2548(outline.m2549("right to "), sideToString(i4), " undefined"));
                }
            ...
            default:
                ...
                sb.append(" to ");
                throw new IllegalArgumentException(outline.m2548(sb, sideToString(i4), " unknown"));
        }
    }
