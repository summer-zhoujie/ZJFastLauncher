...
public class Barrier extends ConstraintHelper {
    ...
    public android.support.constraint.solver.widgets.Barrier mBarrier;
    ...
    public void init(AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            ...
            for (int i = 0; i < indexCount; i++) {
                ...
                if (index == C0007R.styleable.ConstraintLayout_Layout_barrierDirection) {
                    setType(obtainStyledAttributes.getInt(index, 0));
                } else if (index == C0007R.styleable.ConstraintLayout_Layout_barrierAllowsGoneWidgets) {
