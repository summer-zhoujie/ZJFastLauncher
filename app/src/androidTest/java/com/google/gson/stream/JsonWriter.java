...
public class JsonWriter implements Closeable, Flushable {
    ...
    private JsonWriter close(int i, int i2, String str) {
        ...
        if (peek != i2 && peek != i) {
            ...
            StringBuilder r3 = outline.m2549("Dangling name: ");
            r3.append(this.deferredName);
    ...
    public JsonWriter value(Number number) {
        ...
        throw new IllegalArgumentException(outline.m2554("Numeric values must be finite, but was ", (Object) number));
    }
}
