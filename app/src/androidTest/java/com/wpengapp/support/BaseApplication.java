...
public abstract class BaseApplication extends Application {
    ...
    /* renamed from: ރ */
    public Application.ActivityLifecycleCallbacks f566;
    ...
    public boolean mo7795() {
        if (Build.VERSION.SDK_INT >= 23
                && AppUtils.getApplication().getApplicationInfo().targetSdkVersion >= 23
                && AppUtils.m1169()
                && !RequestPermissionHelper.m899(mo7556())
                && SystemUtils.m3507(AppUtils.m1163(), LauncherActivity.class.getName()) != null) {
            return true;
        }
        return false;
    }
    ...
    public final void mo7796() {
        if (!this.f564) {
            this.f564 = true;
            Application.ActivityLifecycleCallbacks activityLifecycleCallbacks = this.f566;
