...
public class ResolutionAnchor extends ResolutionNode {
    ...
    public String toString() {
        if (this.state != 1) {
            ...
            r0.append(this.myAnchor);
            r0.append(" UNRESOLVED} type: ");
            r0.append(sType(this.type));
            return r0.toString();
        } else if (this.resolvedTarget == this) {
            StringBuilder r02 = outline.m2549("[");
            r02.append(this.myAnchor);
            r02.append(", RESOLVED: ");
            r02.append(this.resolvedOffset);
            r02.append("]  type: ");
            r02.append(sType(this.type));
            return r02.toString();
        } else {
            StringBuilder r03 = outline.m2549("[");
            r03.append(this.myAnchor);
            r03.append(", RESOLVED: ");
            r03.append(this.resolvedTarget);
            r03.append(":");
            r03.append(this.resolvedOffset);
            r03.append("] type: ");
            r03.append(sType(this.type));
            return r03.toString();
        }
    }
        ...
        if (this.state != 1 && this.type != 4) {
            ...
            if (this.type == 1 && ((resolutionAnchor7 = this.target) == null || resolutionAnchor7.state == 1)) {
                ...
                if (z) {
                    ...
                    resolutionAnchor10.resolvedOffset = (f8 * f3) + resolutionAnchor10.target.resolvedOffset + f7;
                    this.resolvedOffset = (this.target.resolvedOffset - f6) - ((1.0f - f3) * f8);
                } else {
                    this.resolvedOffset = (f8 * f3) + this.target.resolvedOffset + f6;
                    ResolutionAnchor resolutionAnchor11 = this.opposite;
                    resolutionAnchor11.resolvedOffset = (resolutionAnchor11.target.resolvedOffset - f7) - ((1.0f - f3) * f8);
                }
                didResolve();
