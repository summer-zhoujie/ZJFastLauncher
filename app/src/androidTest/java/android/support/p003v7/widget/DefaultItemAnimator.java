...
public class DefaultItemAnimator extends SimpleItemAnimator {
    ...
    public void runPendingAnimations() {
        ...
        if (z || z2 || z4 || z3) {
            ...
            if (z2) {
                ...
                if (z) {
                    ViewCompat.IMPL.postOnAnimationDelayed(((MoveInfo) arrayList.get(0)).holder.itemView, r6, getRemoveDuration());
                } else {
                    r6.run();
                }
            }
            if (z3) {
                ...
                if (z) {
                    ViewCompat.IMPL.postOnAnimationDelayed(((ChangeInfo) arrayList2.get(0)).oldHolder.itemView, r62, getRemoveDuration());
                } else {
                    r62.run();
                }
            }
            if (z4) {
                ...
                if (z || z2 || z3) {
                    ...
                    ViewCompat.IMPL.postOnAnimationDelayed(((RecyclerView.ViewHolder) arrayList3.get(0)).itemView, r5, Math.max(moveDuration, j) + removeDuration);
                    return;
                }
                r5.run();
            }
    ...
    private static class ChangeInfo {
        ...
        public String toString() {
            StringBuilder r0 = outline.m2549("ChangeInfo{oldHolder=");
            r0.append(this.oldHolder);
            r0.append(", newHolder=");
            r0.append(this.newHolder);
            r0.append(", fromX=");
            r0.append(this.fromX);
            r0.append(", fromY=");
            r0.append(this.fromY);
            r0.append(", toX=");
            r0.append(this.toX);
            r0.append(", toY=");
            r0.append(this.toY);
