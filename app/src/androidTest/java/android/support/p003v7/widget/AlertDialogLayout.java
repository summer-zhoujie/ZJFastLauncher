...
public class AlertDialogLayout extends LinearLayoutCompat {
    ...
    private boolean tryOnMeasure(int i, int i2) {
        ...
        for (int i10 = 0; i10 < childCount; i10++) {
            ...
            if (childAt.getVisibility() != 8) {
                ...
                if (id == C0176R.C0178id.topPanel) {
                    view = childAt;
                } else if (id == C0176R.C0178id.buttonPanel) {
                    view2 = childAt;
                } else if ((id != C0176R.C0178id.contentPanel && id != C0176R.C0178id.customPanel) || view3 != null) {
                    return false;
                } else {
                    view3 = childAt;
                }
    ...
    public void onLayout(boolean r18, int r19, int r20, int r21, int r22) {
        ...
        L_0x005a:
            ...
            r15 = r2
            android.support.v7.widget.LinearLayoutCompat$LayoutParams r15 = (android.support.p003v7.widget.LinearLayoutCompat.LayoutParams) r15
            int r2 = r15.gravity
            if (r2 >= 0) goto L_0x007e
            r2 = r11
        L_0x007e:
            int r3 = android.support.p000v4.view.ViewCompat.getLayoutDirection(r17)
            int r2 = android.support.p000v4.view.GravityCompat.getAbsoluteGravity(r2, r3)
            r2 = r2 & 7
            r3 = 1
        ...
        L_0x00be:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.AlertDialogLayout.onLayout(boolean, int, int, int, int):void");
    }
