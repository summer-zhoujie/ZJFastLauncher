...
public class LinearSmoothScroller extends RecyclerView.SmoothScroller {
    ...
    public PointF computeScrollVectorForPosition(int i) {
        ...
        StringBuilder r3 = outline.m2549("You should override computeScrollVectorForPosition when the LayoutManager does not implement ");
        r3.append(ScrollVectorProvider.class.getCanonicalName());
        r3.toString();
        return null;
    }
    ...
    public void onSeekTargetStep(int i, int i2, RecyclerView.State state, Action action) {
        if (getChildCount() == 0) {
            stop();
            return;
        }
    ...
    public void onTargetFound(View view, RecyclerView.State state, Action action) {
