...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    public SearchView(Context context) {
        this(context, (AttributeSet) null, C0176R.attr.searchViewStyle);
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private Intent createIntentFromSuggestion(Cursor r10, int r11, String r12) {
        /*
            r9 = this;
            r0 = 0
            java.lang.String r1 = "suggest_intent_action"
            java.lang.String r1 = android.support.p003v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
        ...
        L_0x0022:
            ...
            java.lang.String r2 = android.support.p003v7.widget.SuggestionsAdapter.getColumnString(r10, r2)     // Catch:{ RuntimeException -> 0x0061 }
        ...
        L_0x004d:
            ...
            java.lang.String r6 = android.support.p003v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
            java.lang.String r1 = "suggest_intent_extra_data"
            java.lang.String r5 = android.support.p003v7.widget.SuggestionsAdapter.getColumnString(r10, r1)     // Catch:{ RuntimeException -> 0x0061 }
            r2 = r9
            r7 = r11
            r8 = r12
    ...
    private void launchIntent(Intent intent) {
        if (intent != null) {
            try {
                ...
                outline.m2552("Failed launch activity: ", (Object) intent);
            }
        }
    }
    ...
    private void updateQueryHint() {
        ...
        if (queryHint == null) {
            queryHint = BidiFormatter.EMPTY_STRING;
        }
    ...
    public void adjustDropDownSizeAndPosition() {
        ...
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            if (this.mIconifiedByDefault) {
                i = resources.getDimensionPixelSize(C0176R.dimen.abc_dropdownitem_text_padding_left) + resources.getDimensionPixelSize(C0176R.dimen.abc_dropdownitem_icon_width);
            } else {
                i = 0;
            }
    ...
    public void onActionViewCollapsed() {
        setQuery(BidiFormatter.EMPTY_STRING, false);
        clearFocus();
    ...
    public void onActionViewExpanded() {
        if (!this.mExpandedInActionView) {
            ...
            this.mSearchSrcTextView.setText(BidiFormatter.EMPTY_STRING);
            setIconified(false);
        }
    }
    ...
    public SearchView(Context context, AttributeSet attributeSet, int i) {
        ...
        LayoutInflater.from(context).inflate(obtainStyledAttributes.getResourceId(C0176R.styleable.SearchView_layout, C0176R.layout.abc_search_view), this, true);
        ...
        ViewCompat.IMPL.setBackground(this.mSearchPlate, obtainStyledAttributes.getDrawable(C0176R.styleable.SearchView_queryBackground));
        ViewCompat.IMPL.setBackground(this.mSubmitArea, obtainStyledAttributes.getDrawable(C0176R.styleable.SearchView_submitBackground));
