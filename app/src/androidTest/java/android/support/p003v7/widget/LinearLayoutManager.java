...
public class LinearLayoutManager extends RecyclerView.LayoutManager implements ItemTouchHelper.ViewDropHandler, RecyclerView.SmoothScroller.ScrollVectorProvider {
    ...
    static class AnchorInfo {
        ...
        public String toString() {
            StringBuilder r0 = outline.m2549("AnchorInfo{mPosition=");
            r0.append(this.mPosition);
            r0.append(", mCoordinate=");
            r0.append(this.mCoordinate);
            r0.append(", mLayoutFromEnd=");
            r0.append(this.mLayoutFromEnd);
            r0.append(", mValid=");
            r0.append(this.mValid);
            r0.append('}');
            return r0.toString();
        }
    }
    ...
    static class LayoutState {
        ...
        public void log() {
            StringBuilder r0 = outline.m2549("avail:");
        ...
        if (state.willRunPredictiveAnimations() && getChildCount() != 0 && !state.isPreLayout() && supportsPredictiveItemAnimations()) {
            ...
            for (int i5 = 0; i5 < size; i5++) {
                ...
                if (!viewHolder.isRemoved()) {
                    ...
                    if (c == 65535) {
                        i3 = this.mOrientationHelper.getDecoratedMeasurement(viewHolder.itemView) + i3;
                    } else {
                        i4 = this.mOrientationHelper.getDecoratedMeasurement(viewHolder.itemView) + i4;
                    }
                }
            }
    ...
    private void logChildren() {
        for (int i = 0; i < getChildCount(); i++) {
            ...
            StringBuilder r2 = outline.m2549("item ");
            r2.append(getPosition(childAt));
            r2.append(", coord:");
            r2.append(this.mOrientationHelper.getDecoratedStart(childAt));
            r2.toString();
        }
    }
            ...
            if (i < 0 || i >= state.getItemCount()) {
                ...
                if (savedState != null && savedState.hasValidAnchor()) {
                    ...
                    if (findViewByPosition == null) {
                        ...
                        if (anchorInfo.mLayoutFromEnd) {
                            i2 = this.mOrientationHelper.getTotalSpaceChange() + this.mOrientationHelper.getDecoratedEnd(findViewByPosition);
                        } else {
    ...
    public void collectAdjacentPrefetchPositions(int i, int i2, RecyclerView.State state, LayoutPrefetchRegistry layoutPrefetchRegistry) {
    ...
    public void collectPrefetchPositionsForLayoutState(RecyclerView.State state, LayoutState layoutState, LayoutPrefetchRegistry layoutPrefetchRegistry) {
    ...
    public void onLayoutChildren(RecyclerView.Recycler recycler, RecyclerView.State state) {
        ...
        if (anchorInfo2.mLayoutFromEnd) {
            ...
            LayoutState layoutState2 = this.mLayoutState;
            int i12 = layoutState2.mOffset;
            int i13 = layoutState2.mCurrentPosition;
            int i14 = layoutState2.mAvailable;
            if (i14 > 0) {
                endPadding += i14;
            }
            ...
            int i15 = layoutState4.mAvailable;
            if (i15 > 0) {
                updateLayoutStateToFillStart(i13, i12);
                LayoutState layoutState5 = this.mLayoutState;
                layoutState5.mExtra = i15;
            ...
            int i16 = layoutState7.mCurrentPosition;
            int i17 = layoutState7.mAvailable;
            if (i17 > 0) {
            ...
            LayoutState layoutState9 = this.mLayoutState;
            i2 = layoutState9.mOffset;
            int i18 = layoutState9.mAvailable;
            if (i18 > 0) {
                updateLayoutStateToFillEnd(i16, i3);
                LayoutState layoutState10 = this.mLayoutState;
                layoutState10.mExtra = i18;
    ...
    public void setOrientation(int i) {
        ...
        throw new IllegalArgumentException(outline.m2543("invalid orientation:", i));
    }
    ...
    public void validateChildOrder() {
        StringBuilder r0 = outline.m2549("validating child count ");
        ...
        if (getChildCount() >= 1) {
            ...
            if (this.mShouldReverseLayout) {
                ...
                while (i < getChildCount()) {
                    ...
                    if (position2 < position) {
                        logChildren();
                        StringBuilder r3 = outline.m2549("detected invalid position. loc invalid? ");
            ...
            while (i2 < getChildCount()) {
                ...
                if (position3 < position) {
                    logChildren();
                    StringBuilder r32 = outline.m2549("detected invalid position. loc invalid? ");
    ...
    public LinearLayoutManager(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.mLayoutChunkResult = new LayoutChunkResult();
        this.mInitialPrefetchItemCount = 2;
        Properties properties = RecyclerView.LayoutManager.getProperties(context, attributeSet, i, i2);
