...
public class Toolbar extends ViewGroup {
    ...
    public Toolbar(Context context) {
        this(context, (AttributeSet) null, C0176R.attr.toolbarStyle);
    }
    ...
    private void ensureNavButtonView() {
        if (this.mNavButtonView == null) {
            this.mNavButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0176R.attr.toolbarNavigationButtonStyle);
            LayoutParams generateDefaultLayoutParams = generateDefaultLayoutParams();
    ...
    public void ensureCollapseButtonView() {
        if (this.mCollapseButtonView == null) {
            this.mCollapseButtonView = new AppCompatImageButton(getContext(), (AttributeSet) null, C0176R.attr.toolbarNavigationButtonStyle);
    ...
    public int getCurrentContentInsetEnd() {
        ...
        L_0x0029:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.widget.Toolbar.getCurrentContentInsetEnd():int");
    }
    ...
    public Toolbar(Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        int dimensionPixelSize = obtainStyledAttributes.getDimensionPixelSize(C0176R.styleable.Toolbar_contentInsetLeft, 0);
        int dimensionPixelSize2 = obtainStyledAttributes.getDimensionPixelSize(C0176R.styleable.Toolbar_contentInsetRight, 0);
        ensureContentInsets();
