...
public class SuggestionsAdapter extends ResourceCursorAdapter implements View.OnClickListener {
    ...
    public final SearchManager mSearchManager = ((SearchManager) this.mContext.getSystemService("search"));
    ...
    private static final class ChildViewCache {
        ...
        public ChildViewCache(View view) {
            ...
            this.mIconRefine = (ImageView) view.findViewById(C0176R.C0178id.edit_query);
        }
    }
    ...
    private Drawable getDrawable(Uri r5) {
        /*
            r4 = this;
    ...
    private Drawable getDrawableFromResourceValue(String str) {
        ...
        try {
            ...
            outline.m2555("Icon resource not found: ", str);
            return null;
        }
    }
                ...
                if (pathSegments != null) {
                    ...
                    if (size == 1) {
                        try {
                            ...
                            throw new FileNotFoundException(outline.m2554("Single path segment is not a resource ID: ", (Object) uri));
                        }
                    } else if (size == 2) {
                        i = resourcesForApplication.getIdentifier(pathSegments.get(1), pathSegments.get(0), authority);
                    } else {
                        throw new FileNotFoundException(outline.m2554("More than two path segments: ", (Object) uri));
                    }
                    if (i != 0) {
                        return resourcesForApplication.getDrawable(i);
                    }
                    throw new FileNotFoundException(outline.m2554("No resource found for: ", (Object) uri));
                }
                throw new FileNotFoundException(outline.m2554("No path: ", (Object) uri));
            } catch (PackageManager.NameNotFoundException unused2) {
                throw new FileNotFoundException(outline.m2554("No package found for authority: ", (Object) uri));
            }
        } else {
            throw new FileNotFoundException(outline.m2554("No authority: ", (Object) uri));
        }
    }
    ...
    public Cursor getSearchManagerSuggestions(SearchableInfo searchableInfo, String str, int i) {
        ...
        Uri.Builder fragment = new Uri.Builder().scheme("content").authority(suggestAuthority).query(BidiFormatter.EMPTY_STRING).fragment(BidiFormatter.EMPTY_STRING);
    ...
    public View newView(Context context, Cursor cursor, ViewGroup viewGroup) {
        ...
        ((ImageView) inflate.findViewById(C0176R.C0178id.edit_query)).setImageResource(this.mCommitIconResId);
        return inflate;
    }
    ...
    public Cursor runQueryOnBackgroundThread(CharSequence charSequence) {
        String charSequence2 = charSequence == null ? BidiFormatter.EMPTY_STRING : charSequence.toString();
