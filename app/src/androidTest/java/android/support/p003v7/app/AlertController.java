...
public class AlertController {
    ...
    public final View.OnClickListener mButtonHandler = new View.OnClickListener() {
        ...
        public void onClick(View r3) {
            /*
                r2 = this;
                android.support.v7.app.AlertController r0 = android.support.p003v7.app.AlertController.this
            ...
            L_0x002e:
                ...
                r3.sendToTarget()
            L_0x0033:
                android.support.v7.app.AlertController r3 = android.support.p003v7.app.AlertController.this
                android.os.Handler r0 = r3.mHandler
                r1 = 1
                android.support.v7.app.AppCompatDialog r3 = r3.mDialog
                android.os.Message r3 = r0.obtainMessage(r1, r3)
                r3.sendToTarget()
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p003v7.app.AlertController.C01511.onClick(android.view.View):void");
        }
    };
    ...
    public static class RecycleListView extends ListView {
        ...
        public RecycleListView(Context context, AttributeSet attributeSet) {
            ...
            TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0176R.styleable.RecycleListView);
            this.mPaddingBottomNoButtons = obtainStyledAttributes.getDimensionPixelOffset(C0176R.styleable.RecycleListView_paddingBottomNoButtons, -1);
            this.mPaddingTopNoTitle = obtainStyledAttributes.getDimensionPixelOffset(C0176R.styleable.RecycleListView_paddingTopNoTitle, -1);
        }
    }
    ...
    public AlertController(Context context, AppCompatDialog appCompatDialog, Window window) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes((AttributeSet) null, C0176R.styleable.AlertDialog, C0176R.attr.alertDialogStyle, 0);
        this.mAlertDialogLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_android_layout, 0);
        this.mButtonPanelSideLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_buttonPanelSideLayout, 0);
        this.mListLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_listLayout, 0);
        this.mMultiChoiceItemLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_multiChoiceItemLayout, 0);
        this.mSingleChoiceItemLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_singleChoiceItemLayout, 0);
        this.mListItemLayout = obtainStyledAttributes.getResourceId(C0176R.styleable.AlertDialog_listItemLayout, 0);
        this.mShowTitle = obtainStyledAttributes.getBoolean(C0176R.styleable.AlertDialog_showTitle, true);
        this.mButtonIconDimen = obtainStyledAttributes.getDimensionPixelSize(C0176R.styleable.AlertDialog_buttonIconDimen, 0);
    ...
    private void setScrollIndicators(ViewGroup viewGroup, View view, int i, int i2) {
        final View findViewById = this.mWindow.findViewById(C0176R.C0178id.scrollIndicatorUp);
        View findViewById2 = this.mWindow.findViewById(C0176R.C0178id.scrollIndicatorDown);
        if (Build.VERSION.SDK_INT >= 23) {
            ViewCompat.IMPL.setScrollIndicators(view, i, i2);
    ...
    private void setupContent(ViewGroup viewGroup) {
        this.mScrollView = (NestedScrollView) this.mWindow.findViewById(C0176R.C0178id.scrollView);
    ...
    private void setupCustomContent(ViewGroup viewGroup) {
        ...
        if (z) {
            FrameLayout frameLayout = (FrameLayout) this.mWindow.findViewById(C0176R.C0178id.custom);
    ...
    private void setupTitle(ViewGroup viewGroup) {
        if (this.mCustomTitleView != null) {
            ...
            this.mWindow.findViewById(C0176R.C0178id.title_template).setVisibility(8);
            return;
        }
        ...
        this.mTitleView = (TextView) this.mWindow.findViewById(C0176R.C0178id.alertTitle);
    ...
    private void setupView() {
        ...
        View findViewById;
        View findViewById2 = this.mWindow.findViewById(C0176R.C0178id.parentPanel);
        View findViewById3 = findViewById2.findViewById(C0176R.C0178id.topPanel);
        View findViewById4 = findViewById2.findViewById(C0176R.C0178id.contentPanel);
        View findViewById5 = findViewById2.findViewById(C0176R.C0178id.buttonPanel);
        ViewGroup viewGroup = (ViewGroup) findViewById2.findViewById(C0176R.C0178id.customPanel);
        setupCustomContent(viewGroup);
        View findViewById6 = viewGroup.findViewById(C0176R.C0178id.topPanel);
        View findViewById7 = viewGroup.findViewById(C0176R.C0178id.contentPanel);
        View findViewById8 = viewGroup.findViewById(C0176R.C0178id.buttonPanel);
        ...
        if (!z3 && (findViewById = resolvePanel2.findViewById(C0176R.C0178id.textSpacerNoButtons)) != null) {
        ...
        if (z2) {
            ...
            if (!(this.mMessage == null && this.mListView == null)) {
                view = resolvePanel.findViewById(C0176R.C0178id.titleDividerNoCustom);
            }
            if (view != null) {
                view.setVisibility(0);
            }
        } else {
            View findViewById9 = resolvePanel2.findViewById(C0176R.C0178id.textSpacerNoTitle);
