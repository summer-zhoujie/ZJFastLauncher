...
public class FontsContractCompat {
    ...
    public static final Comparator<byte[]> sByteArrayComparator = new Comparator<byte[]>() {
        ...
        public int compare(byte[] r5, byte[] r6) {
            ...
            L_0x001b:
                return r0
            */
            throw new UnsupportedOperationException("Method not decompiled: android.support.p000v4.provider.FontsContractCompat.C01035.compare(byte[], byte[]):int");
        }
    };
    ...
    public static class FontInfo {
        ...
        @RestrictTo({RestrictTo.Scope.LIBRARY_GROUP})
        public FontInfo(@NonNull Uri uri, @IntRange(from = 0) int i, @IntRange(from = 1, mo41to = 1000) int i2, boolean z, int i3) {
            if (uri != null) {
                this.mUri = uri;
                this.mTtcIndex = i;
                this.mWeight = i2;
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:36:0x0089, code lost:
        sBackgroundThread.postAndReply(r1, new android.support.p000v4.provider.FontsContractCompat.C00923());
     */
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static Typeface getFontSync(final Context r2, final FontRequest r3, @android.support.annotation.Nullable final android.support.p000v4.content.res.ResourcesCompat.FontCallback r4, @android.support.annotation.Nullable final Handler r5, boolean r6, int r7, final int r8) {
        /*
    ...
    public static ProviderInfo getProvider(@NonNull PackageManager packageManager, @NonNull FontRequest fontRequest, @Nullable Resources resources) {
        ...
        if (resolveContentProvider == null) {
            throw new PackageManager.NameNotFoundException(outline.m2556("No package found for authority: ", providerAuthority));
