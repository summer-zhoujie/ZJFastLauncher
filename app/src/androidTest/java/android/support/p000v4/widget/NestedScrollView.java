...
public class NestedScrollView extends FrameLayout implements NestedScrollingParent, NestedScrollingChild2, ScrollingView {
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            StringBuilder r0 = outline.m2549("HorizontalScrollView.SavedState{");
            r0.append(Integer.toHexString(System.identityHashCode(this)));
            r0.append(" scrollPosition=");
            r0.append(this.scrollPosition);
            r0.append("}");
            return r0.toString();
        }
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mFillViewport && MeasureSpec.getMode(i2) != 0 && getChildCount() > 0) {
            ...
            if (childAt.getMeasuredHeight() < measuredHeight) {
                childAt.measure(FrameLayout.getChildMeasureSpec(i, getPaddingRight() + getPaddingLeft(), ((LayoutParams) childAt.getLayoutParams()).width), MeasureSpec.makeMeasureSpec((measuredHeight - getPaddingTop()) - getPaddingBottom(), 1073741824));
            }
        }
    }
    ...
    public boolean onTouchEvent(MotionEvent motionEvent) {
        ...
        if (actionMasked != 0) {
            if (actionMasked == 1) {
                ...
                if (findPointerIndex == -1) {
                    StringBuilder r0 = outline.m2549("Invalid pointerId=");
                    r0.append(this.mActivePointerId);
                    ...
                    if (this.mIsBeingDragged) {
                        ...
                        if (dispatchNestedScroll(0, scrollY2, 0, i4 - scrollY2, this.mScrollOffset, 0)) {
                            ...
                            int i6 = scrollY + i4;
                            if (i6 < 0) {
                                EdgeEffectCompat.IMPL.onPull(this.mEdgeGlowTop, ((float) i4) / ((float) getHeight()), motionEvent2.getX(findPointerIndex) / ((float) getWidth()));
                                if (!this.mEdgeGlowBottom.isFinished()) {
                                    this.mEdgeGlowBottom.onRelease();
                                }
                            } else if (i6 > i3) {
                                EdgeEffectCompat.IMPL.onPull(this.mEdgeGlowBottom, ((float) i4) / ((float) getHeight()), 1.0f - (motionEvent2.getX(findPointerIndex) / ((float) getWidth())));
                                if (!this.mEdgeGlowTop.isFinished()) {
    ...
    public NestedScrollView(@NonNull Context context, @Nullable AttributeSet attributeSet, int i) {
        ...
        ViewCompat.IMPL.setAccessibilityDelegate(this, ACCESSIBILITY_DELEGATE);
    }
