...
public class SlidingPaneLayout extends ViewGroup {
    ...
    public static final SlidingPanelLayoutImpl IMPL = new SlidingPanelLayoutImplJBMR1();
    ...
    static class SlidingPanelLayoutImplJBMR1 extends SlidingPanelLayoutImplBase {
        public void invalidateChildRegion(SlidingPaneLayout slidingPaneLayout, View view) {
            ViewCompat.IMPL.setLayerPaint(view, ((LayoutParams) view.getLayoutParams()).dimPaint);
        }
    }
    ...
    private void dimChildView(View view, float f, int i) {
        ...
        if (f > 0.0f && i != 0) {
            ...
            ViewCompat.IMPL.postOnAnimation(this, disableLayerRunnable);
        }
    }
