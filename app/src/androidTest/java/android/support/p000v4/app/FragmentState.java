...
public final class FragmentState implements Parcelable {
    ...
    public Fragment instantiate(FragmentHostCallback fragmentHostCallback, FragmentContainer fragmentContainer, Fragment fragment, FragmentManagerNonConfig fragmentManagerNonConfig, ViewModelStore r8) {
        if (this.mInstance == null) {
            ...
            if (FragmentManagerImpl.DEBUG) {
                StringBuilder r4 = outline.m2549("Instantiated fragment ");
                r4.append(this.mInstance);
                r4.toString();
            }
        }
        Fragment fragment3 = this.mInstance;
        fragment3.mChildNonConfig = fragmentManagerNonConfig;
        fragment3.mViewModelStore = r8;
        return fragment3;
    }
