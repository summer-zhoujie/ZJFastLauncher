...
public class ViewPager extends ViewGroup {
    ...
    public static class SavedState extends AbsSavedState {
        ...
        public String toString() {
            StringBuilder r0 = outline.m2549("FragmentPager.SavedState{");
    ...
    private void completeScroll(boolean z) {
        ...
        if (z) {
            ViewCompat.IMPL.postOnAnimation(this, this.mEndScrollRunnable);
        } else {
    ...
    public void initViewPager() {
        ...
        ViewCompat.IMPL.setAccessibilityDelegate(this, new MyAccessibilityDelegate());
        if (ViewCompat.getImportantForAccessibility(this) == 0) {
            ViewCompat.IMPL.setImportantForAccessibility(this, 1);
        }
        ViewCompat.IMPL.setOnApplyWindowInsetsListener(this, new OnApplyWindowInsetsListener() {
            public final Rect mTempRect = new Rect();
    ...
    public void onMeasure(int r14, int r15) {
        ...
        L_0x0039:
            ...
            android.support.v4.view.ViewPager$LayoutParams r3 = (android.support.p000v4.view.ViewPager.LayoutParams) r3
    ...
    public void populate(int r15) {
        ...
        L_0x0063:
            ...
            int r4 = r14.mCurItem
            android.support.v4.view.ViewPager$ItemInfo r4 = r14.addNewItem(r4, r3)
        L_0x006d:
            r5 = 0
        ...
        L_0x0152:
            ...
            goto L_0x0120
        L_0x016e:
            android.support.v4.view.ViewPager$ItemInfo r7 = r14.addNewItem(r9, r6)
            int r6 = r6 + 1
            float r7 = r7.widthFactor
            float r1 = r1 + r7
            java.util.ArrayList<android.support.v4.view.ViewPager$ItemInfo> r7 = r14.mItems
        ...
        L_0x021e:
            ...
            r1.append(r15)
            java.lang.Class<android.support.v4.view.ViewPager> r15 = android.support.p000v4.view.ViewPager.class
            r1.append(r15)
