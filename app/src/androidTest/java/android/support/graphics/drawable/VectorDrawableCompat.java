...
public class VectorDrawableCompat extends VectorDrawableCommon {
    ...
    public ConstantState mCachedConstantStateDelegate;
    ...
    public static VectorDrawableCompat create(@android.support.annotation.NonNull Resources r4, @android.support.annotation.DrawableRes int r5, @android.support.annotation.Nullable Resources.Theme r6) {
        /*
        ...
        L_0x0032:
            ...
            android.support.graphics.drawable.VectorDrawableCompat r4 = createFromXmlInner(r4, r5, r0, r6)     // Catch:{ IOException | XmlPullParserException -> 0x0041 }
            return r4
        L_0x0039:
    ...
    private void printGroupTree(VGroup vGroup, int i) {
        ...
        StringBuilder r2 = outline.m2550(str, "current group is :");
        r2.append(vGroup.getGroupName());
        r2.append(" rotation is ");
        r2.append(vGroup.mRotate);
        r2.toString();
    ...
    private static class VPath {
        ...
        public String nodesToString(PathParser.PathDataNode[] pathDataNodeArr) {
            ...
            for (int i = 0; i < pathDataNodeArr.length; i++) {
                ...
                r0.append(pathDataNodeArr[i].mType);
                r0.append(":");
                str = r0.toString();
                float[] fArr = pathDataNodeArr[i].mParams;
                for (float append : fArr) {
                    StringBuilder r02 = outline.m2549(str);
                    r02.append(append);
                    r02.append(",");
                    str = r02.toString();
                }
        ...
        public void printVPath(int i) {
            ...
            StringBuilder r4 = outline.m2550(str, "current path is :");
            r4.append(this.mPathName);
            r4.append(" pathData is ");
            r4.append(nodesToString(this.mNodes));
            r4.toString();
        }
